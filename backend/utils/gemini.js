...
async function analyzeProductDescription(description) {
  ...
  try {
    const prompt = `Given the following product or service description, suggest 5 to 8 or more relevant topics ONLY from the provided list that would be most relevant for tracking intent data.
